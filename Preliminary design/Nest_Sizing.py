...
class AeroShield_Nest:
    ...
    def update_storage_size(self, nest_x, nest_y, nest_z):
        """Update the storage size based on the new dimensions.
        Input in [m], updates in [m]"""
        self.nest_x = nest_x
        self.nest_y = nest_y
        self.nest_z = nest_z
        self.nest_vol = nest_x * nest_y * nest_z