...
U_max = 25.5 #Range from 10 to 40V according to paper
F1 = 0.889 #Selected from brushless outrunner motor, most common for UAV
E1 = -0.288 # same
E2 = 0.1588 # same
...
n_mot_cruise = 1
n_mot_vtol = 4
K_material = 0.6 # for composite materials, 1 for plastic
n_props_cruise = 1
n_props_vtol = 4
n_blades_cruise = 4
n_blades_vtol = 4
K_p = 0.0938 # for four blade propellers
