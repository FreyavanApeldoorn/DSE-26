...
T_hover = 0  # Maximum bending moment about y-axis in hover (N·m) 
...
T_cruise = 0  # Maximum bending moment about y-axis in forward flight (N·m)
...
T_vtol = 0  # Maximum bending moment about y-axis in VTOL (N·m)
