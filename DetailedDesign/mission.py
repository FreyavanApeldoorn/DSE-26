...
class Mission:
    ...
    def calc_time_preparation(self) -> float:
        ...
        time_nest_setup =  self.time_unload_container + self.time_open_container + self.time_startup_nest # Time to setup the nest

        time_uav_setup = (self.time_unload_uav + self.time_assemble_uav + self.time_position_uav + self.time_startup_uav) * self.number_of_UAV # Time to setup all UAVs
